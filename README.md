...
- **Tool library** — Open the **Tools** tab. Choose a **Role** (Solution architect or EA), then a **Task** for that role. The prompt and the reply stay on that tab (you can still edit the prompt). Tidy, View, EA, and “suggest patterns” stay report-only; **Pattern** items that start with “Add …” import a fragment via CHANGES JSON.
