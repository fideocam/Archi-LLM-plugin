...
ArchiGPT is a view that provides a text prompt box for interacting with your ArchiMate model via an LLM. Open it in Archi via **Window → Show View → Other… → ArchiGPT → ArchiGPT**.
