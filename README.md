...
- **Tool library** — Open the **Tools** tab. The **Tool** list offers ready-made **Validate**, **Pattern**, and **Analyse** prompts (duplicates and cross-view mismatches, service sandwich, capability slice, and similar). Choosing a tool fills the prompt on the ArchiGPT tab (you can still edit it). Validation and “suggest patterns” stay report-only; **Pattern** items that start with “Add …” import a fragment via CHANGES JSON.
