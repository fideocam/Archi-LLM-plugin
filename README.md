...
**Current features:**
- **Build version**: At the top of the view you see **ArchiGPT v1.0.0.&lt;qualifier&gt;** (e.g. v1.0.0.20250304120000 after a build). Use this to confirm you are running the latest plugin.
